...
const Servismerkezleri = ({ content }) => {
  return (
    <div>
      <div className="Kecidler">
      <a href="/"> <span>{content.EsasSehife}</span></a> 
      <FontAwesomeIcon className='RightIcon' icon={RightIcon} />
      <label>{content.ServisMerkez1}</label>
      </div>
      <div className='filiallar_sozu'>{content.ServisMerkez1}</div>
      ...
      <div className='filiallar_div'>
        <div className='filiallar_kicik_div_part'>
          <div className='filiallar_kicik_div'>
            <span className='adi_filial'>{content.ServisMerkez2} {content.filiali22}</span>
            <span className='adres_filial'> {content.ServisMerkez3}</span>
            <span className='is_saati_filial'>{content.filialiİsSaati} 09:00-18:00</span>
            <span className='tel_filial'>Tel: (+994 12) 478 98 60</span>
            <span className='mob_filial'>Mob: (+994 50) 977 11 81</span>
          </div>
          <div className='filiallar_kicik_div'>
            <span className='adi_filial'>{content.ServisMerkez7} {content.filiali22}</span>
            <span className='adres_filial'>{content.ServisMerkez4}</span>
            <span className='is_saati_filial'>{content.filialiİsSaati} 10:00-21:00</span>
            <span className='tel_filial'>Tel: (+994 12) 478 98 60</span>
            <span className='mob_filial'>Mob: (+994 50) 977 11 81</span>
          </div>
          <div className='filiallar_kicik_div'>
            <span className='adi_filial'>{content.ServisMerkez8} {content.filiali22}</span>
            <span className='adres_filial'>{content.ServisMerkez5}</span>
            <span className='is_saati_filial'>{content.filialiİsSaati} 10:00-21:00</span>
            <span className='tel_filial'>Tel: (+994 12) 478 98 60</span>
            <span className='mob_filial'>Mob: (+994 50) 977 11 81</span>
          </div>
          <div className='filiallar_kicik_div'>
            <span className='adi_filial'>{content.ServisMerkez9} {content.filiali22}</span>
            <span className='adres_filial'>{content.ServisMerkez6}</span>
            <span className='is_saati_filial'>{content.filialiİsSaati} 10:00-21:00</span>
            <span className='tel_filial'>Tel: (+994 12) 478 98 60</span>
            <span className='mob_filial'>Mob: (+994 50) 977 11 81</span>
          </div>
