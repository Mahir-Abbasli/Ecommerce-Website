  ...
  return (
    <div className='Giris'>
      ...
      <div className='Sign_in'>
        <div className='sgnpassword'><a href=''>Şifrənizi unutdunuz?</a></div>
        <hr />
        {isLoggedIn ? (
          ...
          <form onSubmit={handleLogin}>
            <div className='NameForm'>
              ...
              <input className='textform' type="text" name="email"
            ...
            <div className='Forms2'>
              ...
              <input className='passwordform' type='password' name="password" id='password'
                onInput={(e) => setEnteringUser(e)}
            ...
            <div className='Btns'>
              <button onClick={showUp} type="button"  className="Signin">Daxil ol</button>{" "}
